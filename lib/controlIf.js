...
var ControlIf = (function (_Control) {
    ...
    function ControlIf() {
        ...
        _get(Object.getPrototypeOf(ControlIf.prototype), "constructor", this).apply(this, arguments);
    }

    _createClass(ControlIf, [{
        key: "assemble",
        value: function assemble() {
            if (new Function("", this.control + " return true")() === true) this.wXml = this.srcModel.wXml;
        }
    }], [{
        key: "test",
